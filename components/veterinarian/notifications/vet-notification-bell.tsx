...
export function VetNotificationBell({ userId, className = '' }: VetNotificationBellProps) {
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/veterinarian/notifications');
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Skip if already present (e.g. fetched before WS event arrived)
          ...
          // Native push notification when tab is backgrounded
