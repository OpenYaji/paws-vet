...
export default function ClientSidebar({ collapsed, setCollapsed, mobileOpen, setMobileOpen }: ClientSidebarProps) {
...
const menuItems: MenuItem[] = [
    ...
    // { name: 'Help Support', icon: <LifeBuoy size={20} />, path: '/client/help' },
];
        ...
        <aside className="h-screen bg-card border-r text-card-foreground flex flex-col w-64 p-4">
          <header className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-sm">PAWS Client</span>
            </div>
